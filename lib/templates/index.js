let mod = angular.module('Teknoputra.Ionic.templates', []);
...
mod.run(($templateCache) => {
    ...
    $templateCache.put('module/menuTab.html', require('!html!./module/menuTab.html'));
    ...
    $templateCache.put('module/login.html', require('!html!./module/login.html'));
    $templateCache.put('module/signup.html', require('!html!./module/signup.html'));
    $templateCache.put('module/profile.html', require('!html!./module/profile.html'));
